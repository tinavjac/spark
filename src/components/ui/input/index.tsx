...
const inputStyle = tva({
  base: "border-neutral-200 flex-row overflow-hidden content-center data-[hover=true]:border-neutral-800 data-[focus=true]:border-neutral-800 data-[focus=true]:hover:border-neutral-800 data-[disabled=true]:opacity-40 data-[disabled=true]:hover:border-neutral-200 items-center",
...
const inputFieldStyle = tva({
  base: "flex-1 text-neutral-800 py-0 px-3 placeholder:text-neutral-400 h-full ios:leading-[0px] web:cursor-text web:data-[disabled=true]:cursor-not-allowed",
